...
const (
	// Label holds the string label denoting the commissionstructureschema type in the database.
	Label = "commission_structure_schema"
	...
	// Table holds the table name of the commissionstructureschema in the database.
	Table = "commission_structure_schemas"
	...
	ProductSellerColumn = "commission_structure_schema_product_seller"
)

// Columns holds all SQL columns for commissionstructureschema fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "commission_structure_schemas"
...
// OrderOption defines the ordering options for the CommissionStructureSchema queries.
...
func ByCommissionPercentage(opts ...sql.OrderTermOption) OrderOption {
