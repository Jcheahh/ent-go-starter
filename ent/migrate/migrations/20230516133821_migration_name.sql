...
CREATE TABLE "commission_structures" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "name" character varying NOT NULL, "description" character varying NOT NULL, "commission_value" character varying NOT NULL, "commission_percentage" character varying NOT NULL, "product_commission_structure" bigint NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "notifications" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "title" character varying NOT NULL, "content" character varying NOT NULL, "date_created" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "date_updated" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "read" boolean NOT NULL, "user_notifications" bigint NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "shipping_addresses" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "name" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "zip" character varying NOT NULL, "country" character varying NOT NULL, "date_created" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "date_updated" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "user_shipping_addresses" bigint NULL, PRIMARY KEY ("id"));
-- Create "shops" table
...
CREATE TABLE "user_sellers" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "brand_name" character varying NOT NULL, "blog_post_author" bigint NULL, "commission_structure_product_seller" bigint NULL, "product_product_seller" bigint NULL, PRIMARY KEY ("id"));
-- Create "users" table
CREATE TABLE "users" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "zip" character varying NOT NULL, "country" character varying NOT NULL, "date_created" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "date_updated" character varying NOT NULL DEFAULT '2023-05-16T21:38:21+08:00', "notification_recipient" bigint NULL, "user_buyer_user_profile" bigint NULL, "user_influencer_user_profile" bigint NULL, "user_seller_user_profile" bigint NULL, PRIMARY KEY ("id"));
...
-- Modify "commission_structures" table
ALTER TABLE "commission_structures" ADD CONSTRAINT "commission_structures_products_commissionStructure" FOREIGN KEY ("product_commission_structure") REFERENCES "products" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
...
ALTER TABLE "user_sellers" ADD CONSTRAINT "user_sellers_blog_posts_author" FOREIGN KEY ("blog_post_author") REFERENCES "blog_posts" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "user_sellers_commission_structures_productSeller" FOREIGN KEY ("commission_structure_product_seller") REFERENCES "commission_structures" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, ADD CONSTRAINT "user_sellers_products_productSeller" FOREIGN KEY ("product_product_seller") REFERENCES "products" ("id") ON UPDATE NO ACTION ON DELETE SET NULL;
-- Modify "users" table
