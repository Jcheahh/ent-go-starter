...
func (*PaymentMethod) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case paymentmethod.FieldID, paymentmethod.FieldXid:
...
func (pm *PaymentMethod) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", pm.Xid))
	builder.WriteByte(')')
