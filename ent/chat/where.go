...
func Xid(v int) predicate.Chat {
	return predicate.Chat(sql.FieldEQ(FieldXid, v))
}

// XidEQ applies the EQ predicate on the "xid" field.
func XidEQ(v int) predicate.Chat {
	return predicate.Chat(sql.FieldEQ(FieldXid, v))
}

// XidNEQ applies the NEQ predicate on the "xid" field.
func XidNEQ(v int) predicate.Chat {
	return predicate.Chat(sql.FieldNEQ(FieldXid, v))
}

// XidIn applies the In predicate on the "xid" field.
func XidIn(vs ...int) predicate.Chat {
	return predicate.Chat(sql.FieldIn(FieldXid, vs...))
}

// XidNotIn applies the NotIn predicate on the "xid" field.
func XidNotIn(vs ...int) predicate.Chat {
	return predicate.Chat(sql.FieldNotIn(FieldXid, vs...))
}

// XidGT applies the GT predicate on the "xid" field.
func XidGT(v int) predicate.Chat {
	return predicate.Chat(sql.FieldGT(FieldXid, v))
}

// XidGTE applies the GTE predicate on the "xid" field.
func XidGTE(v int) predicate.Chat {
	return predicate.Chat(sql.FieldGTE(FieldXid, v))
}

// XidLT applies the LT predicate on the "xid" field.
func XidLT(v int) predicate.Chat {
	return predicate.Chat(sql.FieldLT(FieldXid, v))
}

// XidLTE applies the LTE predicate on the "xid" field.
func XidLTE(v int) predicate.Chat {
	return predicate.Chat(sql.FieldLTE(FieldXid, v))
}
