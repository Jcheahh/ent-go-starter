...
func Xid(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldEQ(FieldXid, v))
}

// XidEQ applies the EQ predicate on the "xid" field.
func XidEQ(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldEQ(FieldXid, v))
}

// XidNEQ applies the NEQ predicate on the "xid" field.
func XidNEQ(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldNEQ(FieldXid, v))
}

// XidIn applies the In predicate on the "xid" field.
func XidIn(vs ...int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldIn(FieldXid, vs...))
}

// XidNotIn applies the NotIn predicate on the "xid" field.
func XidNotIn(vs ...int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldNotIn(FieldXid, vs...))
}

// XidGT applies the GT predicate on the "xid" field.
func XidGT(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldGT(FieldXid, v))
}

// XidGTE applies the GTE predicate on the "xid" field.
func XidGTE(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldGTE(FieldXid, v))
}

// XidLT applies the LT predicate on the "xid" field.
func XidLT(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldLT(FieldXid, v))
}

// XidLTE applies the LTE predicate on the "xid" field.
func XidLTE(v int) predicate.BankAccount {
	return predicate.BankAccount(sql.FieldLTE(FieldXid, v))
}
