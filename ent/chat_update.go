...
func (cu *ChatUpdate) SetXid(i int) *ChatUpdate {
	cu.mutation.ResetXid()
	cu.mutation.SetXid(i)
	return cu
}

// AddXid adds i to the "xid" field.
func (cu *ChatUpdate) AddXid(i int) *ChatUpdate {
	cu.mutation.AddXid(i)
	return cu
}
...
func (cu *ChatUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.Xid(); ok {
		_spec.SetField(chat.FieldXid, field.TypeInt, value)
	}
	if value, ok := cu.mutation.AddedXid(); ok {
		_spec.AddField(chat.FieldXid, field.TypeInt, value)
	}
...
// SetXid sets the "xid" field.
func (cuo *ChatUpdateOne) SetXid(i int) *ChatUpdateOne {
	cuo.mutation.ResetXid()
	cuo.mutation.SetXid(i)
	return cuo
}

// AddXid adds i to the "xid" field.
func (cuo *ChatUpdateOne) AddXid(i int) *ChatUpdateOne {
	cuo.mutation.AddXid(i)
	return cuo
}
...
func (cuo *ChatUpdateOne) sqlSave(ctx context.Context) (_node *Chat, err error) {
	...
	if value, ok := cuo.mutation.Xid(); ok {
		_spec.SetField(chat.FieldXid, field.TypeInt, value)
	}
	if value, ok := cuo.mutation.AddedXid(); ok {
		_spec.AddField(chat.FieldXid, field.TypeInt, value)
	}
