...
func Xid(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldEQ(FieldXid, v))
}

// XidEQ applies the EQ predicate on the "xid" field.
func XidEQ(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldEQ(FieldXid, v))
}

// XidNEQ applies the NEQ predicate on the "xid" field.
func XidNEQ(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldNEQ(FieldXid, v))
}

// XidIn applies the In predicate on the "xid" field.
func XidIn(vs ...int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldIn(FieldXid, vs...))
}

// XidNotIn applies the NotIn predicate on the "xid" field.
func XidNotIn(vs ...int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldNotIn(FieldXid, vs...))
}

// XidGT applies the GT predicate on the "xid" field.
func XidGT(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldGT(FieldXid, v))
}

// XidGTE applies the GTE predicate on the "xid" field.
func XidGTE(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldGTE(FieldXid, v))
}

// XidLT applies the LT predicate on the "xid" field.
func XidLT(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldLT(FieldXid, v))
}

// XidLTE applies the LTE predicate on the "xid" field.
func XidLTE(v int) predicate.PaymentMethod {
	return predicate.PaymentMethod(sql.FieldLTE(FieldXid, v))
}
