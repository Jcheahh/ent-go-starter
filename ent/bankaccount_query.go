...
type BankAccountQuery struct {
	...
	loadTotal  []func(context.Context, []*BankAccount) error
...
func (baq *BankAccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*BankAccount, error) {
	...
	for i := range baq.loadTotal {
		if err := baq.loadTotal[i](ctx, nodes); err != nil {
			return nil, err
		}
	}
	return nodes, nil
